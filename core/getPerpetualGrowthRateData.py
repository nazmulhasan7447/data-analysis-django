...
def estimate_growth_rate(ticker, CRP, CSRP, rating, premium):
    ...
    DE_ratio = (Total_debt / Equity_BV) * 100
    ...
    Perpetual_Growth_Rate = round(round(random.uniform(Growth_rate - 0.02, Growth_rate + 0.01), 4) * 100, 2)
    ...
    data = {
        ...
        'perpetual_gowth_rate': Perpetual_Growth_Rate,
        'de_ratio': DE_ratio,
        'beta': beta
    }
    print(data)
...
# requested_ticker = input('Enter a ticker : ')
#
...
#     # print('D/E Ratio = ', DE_ratio)
#
#     Debt_percent = (DE_ratio / (DE_ratio + 1)) * 100
#
#
#
#     #print('Net Operating Income = ', Net_Operating_Income)
...
#
#     # Store in DB - WACC
#     WACC = (Kd * float(Debt_percent)) + (Ke * (1 - float(Debt_percent)))
#
#
#
#     #Store in DB - Perpetual Growth Rate
